      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 70% 50% at 50% 50%,rgba(201,168,76,.06),transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          ...
          <h1 style={{ fontSize: "clamp(28px,7vw,60px)" }}>
          ...
          >
            Ready to grow your local visibility? Tell me about your business and
            ...
            {sent ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                ...
                <p style={{ color: "var(--muted)" }}>
                  I&apos;ll get back to you within 2 business hours.
                </p>
              </div>
            ) : (
              <>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    placeholder="Tell me about your business, current rankings, challenges and what success looks like for you..."
                    value={form.message}
                    onChange={(e) =>
                ...
                >
                  I respond within 2 business hours. Your info is 100%
                  confidential.
                </p>
              </>
            )}
              ...
              {[
                {
                  ...
                  val: (
                    <a
                      href="mailto:contact@faisalseo.com"
                      style={{ color: "var(--gold)" }}
                    >
                      contact@faisalseo.com
                    </a>
                  ),
                },
                {
                  ...
                  label: "WhatsApp",
                  val: (
                    <span style={{ color: "var(--muted)" }}>+923466127774</span>
                  ),
                },
                {
                  icon: "🔗",
                  ...
                  val: (
                    <a
                      href="https://www.linkedin.com/in/faisallseo/"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "var(--gold)" }}
                    >
                      linkedin.com/in/faisallseo
                    </a>
                  ),
                },
                {
                  ...
                  val: (
                    <a
                      href="https://www.upwork.com/freelancers/~01caf2a54582f779b8"
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "var(--gold)" }}
                    >
