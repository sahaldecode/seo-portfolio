...
export const metadata: Metadata = {
  ...
  keywords: [
    "SEO Expert Pakistan", "Technical SEO", "AI SEO",
    "AEO", "GEO", "LLM Visibility", "Semantic SEO",
    "Entity SEO", "Local SEO", "SEO Consultant",
  ],
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "SEO Expert Pakistan" }],
  },
  twitter: {
  ...
  alternates: { canonical: "https://seoexpert.pk" },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${sora.variable} ${dmSans.variable} ${jetbrains.variable} min-h-screen bg-dark text-foreground overflow-x-hidden`}
      >
        <StructuredData />
