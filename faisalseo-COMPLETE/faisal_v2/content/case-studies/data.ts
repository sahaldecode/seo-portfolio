// ═══════════════════════════════════════════════════════════════════
// 📁 CASE STUDIES DATA FILE — Easy to edit!
// ═══════════════════════════════════════════════════════════════════
//
// HOW TO ADD A NEW CASE STUDY:
// 1. Copy the template at the bottom of this file
// 2. Paste it inside the caseStudies array (before the closing ])
// 3. Add a comma after the previous entry
// 4. "slug" must be unique — it becomes the URL
//    Example: "my-hvac-client" → /case-studies/my-hvac-client/
// 5. Save the file — the website updates automatically
//
// IMAGE: Put your case study image in /public/images/
//        Name it:  case-{slug}.jpg  or  case-{slug}.png
//        If no image found, a default placeholder is shown.
//
// INDUSTRY OPTIONS (controls image fallback):
//   "Cleaning" | "HVAC" | "Healthcare" | "Roofing" | "Dental" | "Home Services"
//   "E-Commerce" | "Restaurant" | "SaaS" | "Local Business" | "Finance"
//
// ═══════════════════════════════════════════════════════════════════

export interface TrafficData  { month: string; traffic: number; }
export interface KeywordWin   { keyword: string; position: number; volume: number; }
export interface Result       { metric: string; value: string; label: string; }
...
export interface CaseStudy {
  ...
  timeline?:              string;
  description:            string;
  // Hero result pills (4 recommended)
  results:                Result[];
  // Before / After Search Console data (optional)
  beforeAfter?: {
  ...
  // Bar chart (8 months recommended)
...
export const caseStudies: CaseStudy[] = [
  // ─────────────────────────────────────────────────────
  // CASE STUDY 1 — Fresh Start Facility Services
  // ─────────────────────────────────────────────────────
  {
    ...
    location:    "USA",
    timeline:    "6 Months",
    description: "How a complete Local SEO overhaul transformed Fresh Start Facility Services from invisible to dominant — generating 8.4K clicks, 3.01M impressions and a 45% improvement in average position.",
    results: [
    ...
    tools: ["Google Search Console", "Google Business Profile", "Ahrefs", "Screaming Frog", "BrightLocal", "PageSpeed Insights", "SEMrush"],
    testimonial: {
      quote:   "Faisal completely transformed our online presence. We went from getting maybe one call a week from the web to now getting 8-10 qualified leads every week. The ROI has been incredible.",
      author:  "Mark D.",
      role:    "Owner",
    ...
    keywordWins: [
      { keyword: "commercial cleaning services near me",   position: 2,  volume: 4400 },
      { keyword: "office cleaning company [city]",         position: 1,  volume: 2900 },
      { keyword: "medical facility cleaning services",     position: 3,  volume: 1600 },
      { keyword: "janitorial services for small business", position: 2,  volume: 2200 },
      { keyword: "warehouse cleaning services",            position: 1,  volume: 1300 },
    ],
  },

  // ─────────────────────────────────────────────────────
  // CASE STUDY 2 — Go To Superior HVAC
  // ─────────────────────────────────────────────────────
  {
    ...
    location:    "USA",
    timeline:    "8 Months",
    description: "Local SEO and GBP campaign that pushed Go To Superior HVAC to the top of Google Maps and increased inbound calls by 87% — during both peak and off-peak seasons.",
    results: [
    ...
    tools: ["Google Business Profile", "BrightLocal", "Ahrefs", "CallRail", "PageSpeed Insights", "Screaming Frog"],
    testimonial: {
      quote:   "Our phone rings constantly now. Last summer was our best season ever and we attribute most of that growth to Faisal's SEO work. We are ranking in maps for basically every city we service.",
      author:  "Tom R.",
      role:    "Owner",
    ...
    keywordWins: [
      ...
      { keyword: "air conditioning tune up near me",    position: 2,  volume: 2200 },
    ],
  },

  // ─────────────────────────────────────────────────────
  // CASE STUDY 3 — Fraum Center Healthcare
  // ─────────────────────────────────────────────────────
  {
    ...
    location:    "USA",
    timeline:    "10 Months",
    description: "Healthcare local SEO campaign that rebuilt Fraum Center's entire online authority — resulting in 120% organic traffic growth and dominant positions for high-value patient search terms.",
    results: [
    ...
    tools: ["Google Search Console", "Ahrefs", "SEMrush", "Screaming Frog", "BrightLocal", "Google Analytics 4"],
    testimonial: {
      quote:   "We had tried SEO before with poor results. Faisal took a completely different approach — he understood healthcare marketing and built something that actually brings in new patients consistently.",
      author:  "Dr. Sarah M.",
  ...
  // ─────────────────────────────────────────────────────
  {
    ...
    location:    "USA",
    timeline:    "7 Months",
    description: "Comprehensive local SEO strategy that pushed Elite Roofing to #1 for 15+ high-value keywords in a competitive metro market — tripling monthly leads from organic search.",
    results: [
    ...
    challenge: "Elite Roofing was competing against national franchise brands with massive budgets. Despite 12 years of local experience, they were invisible online. Their website was outdated with no local SEO structure, no service pages for specific roofing types, and their GBP was unverified and incomplete.",
    strategy: [
    ...
    tools: ["Ahrefs", "SEMrush", "BrightLocal", "Google Business Profile", "CallRail", "PageSpeed Insights"],
    testimonial: {
      quote:   "I was skeptical because we had been burned by SEO agencies before. Faisal was different — he showed up with a real plan and delivered real results. Our busiest season ever.",
      author:  "Jason K.",
      role:    "Owner",
  ...
  // ─────────────────────────────────────────────────────
  // CASE STUDY 5 — Bright Smile Dental
  // ─────────────────────────────────────────────────────
  {
    ...
    location:    "USA",
    timeline:    "5 Months",
    description: "GBP optimization and local SEO strategy that placed Bright Smile Dental at #1 in the local pack for 9 service keywords and grew new patient appointments by 87%.",
    results: [
    ...
    tools: ["Google Business Profile", "BrightLocal", "Ahrefs", "Birdeye", "PageSpeed Insights"],
    testimonial: {
      quote:   "Within 3 months we were getting more new patient calls than from our paid ads — and those patients convert better because they found us organically. Faisal delivered exactly what he promised.",
      author:  "Dr. Lisa C.",
      role:    "Practice Owner",
  ...
  // ─────────────────────────────────────────────────────
  // CASE STUDY 6 — HomeGuard Security
  // ─────────────────────────────────────────────────────
  {
    slug:        "homeguard-security",
    title:       "2.4× Conversion Rate & -45% Cost Per Lead",
    client:      "HomeGuard Security",
    industry:    "Home Services",
    location:    "USA",
    timeline:    "6 Months",
    description: "Technical SEO overhaul combined with Local Service Ads optimization that cut HomeGuard Security's cost per lead in half while more than doubling their conversion rate from organic traffic.",
    results: [
      { metric: "Conversion Rate",     value: "2.4×",   label: "improvement"      },
    ...
    tools: ["Google Search Console", "Google Local Services Ads", "Screaming Frog", "Hotjar", "PageSpeed Insights", "CallRail"],
    testimonial: {
      quote:   "We were on the verge of cutting our marketing budget when Faisal turned things around completely. Our ads now work better AND we have organic leads coming in that cost us almost nothing.",
      author:  "Mike T.",
    ...
    keywordWins: [
      ...
      { keyword: "security alarm installation [city]",     position: 1,  volume: 2900  },
      { keyword: "home alarm monitoring services",         position: 3,  volume: 3600  },
      { keyword: "smart home security near me",            position: 2,  volume: 4400  },
      { keyword: "security camera installation near me",   position: 1,  volume: 6600  },
    ],
  },

  // ════════════════════════════════════════════════════════════
  // ➕ ADD NEW CASE STUDY HERE — Copy template below:
  // ════════════════════════════════════════════════════════════
  //
  // {
  //   slug:        "client-name-industry",
  //   title:       "Your Project Title",
  //   client:      "Client Company Name",
  //   industry:    "HVAC",           // See INDUSTRY OPTIONS above
  //   location:    "USA",
  //   timeline:    "6 Months",
  //   description: "One to two sentences summarizing results and approach.",
  //   results: [
  ...
  //   },
  //   challenge: "Describe what the client was struggling with...",
  //   strategy: [
  //     "Strategy step 1",
  //     "Strategy step 2",
  //   ],
